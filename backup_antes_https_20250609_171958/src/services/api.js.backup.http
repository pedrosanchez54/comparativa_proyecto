...
// - En local: 'https://localhost:4000/api'
// - En red local: 'https://192.168.1.82:4000/api'
// - Desde fuera (DDNS): 'https://proyectocomparativa.ddns.net/api'
// Puedes usar un archivo .env para cambiarlo fácilmente sin tocar el código.
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://localhost:4000/api';

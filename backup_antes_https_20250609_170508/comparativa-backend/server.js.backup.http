...
app.use(cors({
  origin: [
    ...
    'http://proyectocomparativa.ddns.net:3000'  // Acceso externo por DDNS (reemplaza por tu dominio DDNS real)
  ],
...
app.use(helmet({
  ...
  contentSecurityPolicy: {
    directives: {
      ...
      "img-src": ["'self'", "data:", "http://proyectocomparativa.ddns.net:4000"],
    },
  },
}));

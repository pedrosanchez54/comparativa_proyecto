...
update_server_js() {
    ...
    sed -i "s|'http://proyectocomparativa.ddns.net:3000'|'https://proyectocomparativa.ddns.net'|g" comparativa-backend/server.js
    
    # Actualizar CSP img-src
    sed -i 's|"http://proyectocomparativa.ddns.net:4000"|"https://proyectocomparativa.ddns.net"|g' comparativa-backend/server.js
...
update_backend_controllers() {
    ...
    find comparativa-backend/controllers -name "*.js" -type f -exec sed -i 's|http://proyectocomparativa.ddns.net:4000|https://proyectocomparativa.ddns.net|g' {} \;
...
update_frontend_api() {
    ...
    if [ -f "comparativa-frontend/src/services/api.js" ]; then
        ...
        sed -i "s|'http://TU_DDNS_AQUI:4000/api'|'https://proyectocomparativa.ddns.net/api'|g" comparativa-frontend/src/services/api.js
        sed -i "s|http://localhost:4000/api|https://localhost:4000/api|g" comparativa-frontend/src/services/api.js
...
update_frontend_files() {
    ...
    find comparativa-frontend/src -name "*.js" -o -name "*.jsx" -type f -exec sed -i 's|http://proyectocomparativa.ddns.net:4000|https://proyectocomparativa.ddns.net|g' {} \;
...
update_management_scripts() {
    ...
    if [ -f "start-production.sh" ]; then
        ...
        sed -i 's|http://$DDNS_DOMAIN:3000|https://$DDNS_DOMAIN|g' start-production.sh
        sed -i 's|http://$DDNS_DOMAIN:4000|https://$DDNS_DOMAIN/api|g' start-production.sh
    fi
    
    # Actualizar configure-ddns.sh
    if [ -f "configure-ddns.sh" ]; then
        cp configure-ddns.sh configure-ddns.sh.backup.http
        sed -i 's|http://$DDNS_DOMAIN:3000|https://$DDNS_DOMAIN|g' configure-ddns.sh
        sed -i 's|http://$DDNS_DOMAIN:4000|https://$DDNS_DOMAIN|g' configure-ddns.sh
    fi
    
    # Actualizar otros scripts
    sed -i 's|http://proyectocomparativa.ddns.net:3000|https://proyectocomparativa.ddns.net|g' *.sh 2>/dev/null || true
    sed -i 's|http://proyectocomparativa.ddns.net:4000|https://proyectocomparativa.ddns.net/api|g' *.sh 2>/dev/null || true
...
update_documentation() {
    ...
    if [ -f "README-DEPLOYMENT.md" ]; then
        ...
        sed -i 's|http://tu-dominio.ddns.net:3000|https://tu-dominio.ddns.net|g' README-DEPLOYMENT.md
        sed -i 's|http://tu-dominio.ddns.net:4000|https://tu-dominio.ddns.net/api|g' README-DEPLOYMENT.md
    ...
    if [ -f "memoria_proyecto.md" ]; then
        ...
        sed -i 's|http://proyectocomparativa.ddns.net:3000|https://proyectocomparativa.ddns.net|g' memoria_proyecto.md
        sed -i 's|http://proyectocomparativa.ddns.net:4000|https://proyectocomparativa.ddns.net/api|g' memoria_proyecto.md
    fi
...
# URLs con HTTPS
FRONTEND_URL=https://proyectocomparativa.ddns.net
BASE_URL=https://proyectocomparativa.ddns.net
...
REACT_APP_IMAGE_BASE_URL=https://proyectocomparativa.ddns.net
HTTPS=true
EOF
